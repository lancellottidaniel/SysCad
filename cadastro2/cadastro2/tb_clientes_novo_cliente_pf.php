...
$result = $ServiceDb_corretor->tb_clientes_novo_cliente_pf();
?>
...
<form method="get">
    ...
    <thead class="thead-inverse">
        ...
        <th align="center" bgcolor="white">Nome do Cliente</th>
	...
	foreach($result as $select_linha)
		{
			echo '<tr>';
			echo '<td align="center" bgcolor="white"><a href="http://intranet.nunesegrossi.com.br/cadastro2/pagpesquisa.php?nconsulta=' . $select_linha['cd_pf'] . '">' . $select_linha['cd_pf'] . '</a></td>';
			echo '<td align="center" bgcolor="white">' . $select_linha['nm_pf'] . '</td>';
			echo '<td align="center" bgcolor="white">' . $_SESSION['nome_usuario'] . '</td>';
			echo '<td align="center" bgcolor="white"><a href="http://intranet.nunesegrossi.com.br/cadastro2/agenda.php?nconsulta=' . $select_linha['cd_pf'] . '">Agenda</a></td>';
			echo '</tr>';
